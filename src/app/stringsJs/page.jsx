...
export default function String() {
    ...
    const menuItems = [
        { href: '#item_1', text: '¿Qué es un String?' },
        { href: '#item_2', text: 'Posiciones y substrings' },
        { href: '#item_3', text: 'Buscar y remplazar' },
        { href: '#item_4', text: 'Modificar cadenas de texto' }
    ];
    ...
    return (
        <div className="min-h-screen">
            ...
            {/* Contenido principal */}
            <main className={`transition-all duration-300 min-h-screen ${isCollapsed ? 'ml-0' : 'ml-[200px]'
                }`}>
