        ...
        <>
            ...
            <div className="li-nav">
                ...
                <div className="text-center p-8 font-mono">
                    ...
                    <h1 className="text-5xl font-bold mb-2 text-yellow-300">Catalogo</h1>
                    <h2 className="text-4xl font-bold mb-2 text-indigo-300">de</h2>
                    <h1 className="text-5xl font-bold mb-4 text-yellow-300">componentes</h1>
                    <p className="text-pink-300 text-xl mb-4">Mapa de guia</p>
