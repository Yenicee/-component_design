...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      ...
      <body className={`${inter.className} bg-white dark:bg-medium dark:text-white `}>
